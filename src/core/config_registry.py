...
_FIELD_DEFINITIONS: Dict[str, Dict[str, Any]] = {
    ...
    "ENABLE_REALTIME_TECHNICAL_INDICATORS": {
        ...
        "description": "Use intraday realtime price for MA5/MA10/MA20 and trend alignment (Issue #234). Disable to use yesterday close.",
        "category": "data_source",
        "data_type": "boolean",
        "ui_control": "switch",
        "is_sensitive": False,
    ...
    "PUSHPLUS_TOPIC": {
        ...
        "description": "Group topic code for PushPlus one-to-many push. When configured, messages are sent to all subscribers in the group.",
        "category": "notification",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
